...
Q31 = redondear(x × 2^31)

Para el mismo valor:

Q31 = 0,5 × 2147483648 = 1073741824

Posteriormente, para recuperar el valor real se divide el entero entre el mismo factor de escalada.
...
Sin embargo, antes de almacenar el resultado debe verificarse si existe desbordamiento. Por ejemplo, sumar dos valores cercanos a 1 puede superar el máximo representable.
...
donde x[n] representa la señal de entrada yh[k] los coeficientes del filtro.

Cuando se utiliza Q15, tanto la señal como los coeficientes pueden almacenarse como valores de 16 bits. Cada multiplicación produce un resultado de mayor precisión y los productos se acumulan antes de realizar la conversión final.

CMSIS-DSP dispone de funciones como arm_fir_q15()y arm_fir_q31()para implementar filtros FIR directamente con estas representaciones. En la implementación Q15 documentada por ARM, los productos 2.30 pueden acumularse utilizando un acumulador interno de 64 bits, reduciendo considerablemente el riesgo de desbordamiento durante la acumulación. [6]
...
No obstante, trabajar con punto fijo requiere un análisis cuidadoso del escalamiento, desbordamiento, saturación y precisión de los resultados intermedios. La selección incorrecta de la escala puede provocar pérdida de información o resultados numéricamente inestables.
...
[3] Arm, “CMSIS-DSP: Conversión de valor de punto fijo de 32 bits”, Documentación de Arm CMSIS-DSP , 2026.

[4] Arm Software, “Implementación de punto fijo CMSIS-DSP”, GitHub , Arm-software/CMSIS-DSP, 2026.

[5] Arm, “CMSIS-DSP: Convolución”, Documentación de Arm CMSIS-DSP , 2026.

[6] Arm, “CMSIS-DSP: Filtros de respuesta de impulso finito (FIR)”, Documentación de Arm CMSIS-DSP , 2026.

[7] Arm, Procesamiento de señales digitales usando microcontroladores basados ​​en Arm Cortex-M: teoría y práctica , Arm Education Media, 2025.

[8] Arm, “Escriba la implementación CMSIS-DSP Q15”, Arm Learning Paths , 2026.
