...
EOF
  ...
  echo "----------------------------------------------------------------------"
  echo "   ${C_YELLOW}Nota:${C_RESET} si corriste esto en AWS CloudShell, el archivo"
  echo "   ${KEY_NAME}.pem quedó en tu home de CloudShell (persiste entre sesiones)."
  echo "   Para conectarte por SSH desde tu propia laptop, descárgalo con"
  echo "   Actions > Download file en CloudShell (ruta: ~/${KEY_NAME}.pem)."
  echo "----------------------------------------------------------------------"
